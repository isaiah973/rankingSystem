      ...
      <div className="min-h-[100vh] flex items-start justify-center bg-gradient-to-br from-blue-50 to-gray-100 p-6">
        <div className="bg-white shadow-lg rounded-2xl max-w-md w-full p-8 text-center border border-gray-200">
          ...
          <p className="text-gray-600">
            Please send your voting payment to the account below ( ₦100 per
            vote) 👇
          </p>
          <p className="italic text-sm mb-6">
            Your Payment Description is the Code of the contestant you are
            voting for.
          </p>

          <div className="bg-blue-50 p-4 rounded-xl border border-blue-200 text-left mb-6">
            <p className="text-gray-700 mb-2">
              <span className="font-semibold">Account Name:</span> Doreen Samuel
              Kunle (Opay)
            </p>
            <p className="text-gray-700 mb-2">
          ...
          <p className="text-sm text-gray-500 mb-4">
            After making payment, please send your receipt or screenshot to us
